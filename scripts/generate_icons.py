...
# Basic SVG structure with configurable color (defaulting to white for dark mode)
...
# Color for all icons (Monochrome White)
ICON_COLOR = "#FFFFFF"
...
ICONS = {
    ...
    "stop": '<rect x="4" y="4" width="16" height="16"></rect>',
    ...
    # Creative / Illustration (Updated & Expanded)
    ...
    "brush": '<path d="M18 10h-2.5a2.5 2.5 0 1 1 3-2.5V11a2 2 0 0 1-2 2H5a2 2 0 0 0-2 2 2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5"></path>',
    ...
    "eraser": '<path d="M20 20H7L3 16C2 15 2 13 3 12L13 2L22 11L20 20Z"></path><path d="M17 17L7 7"></path>',
    ...
    "calculator": '<rect x="4" y="2" width="16" height="20" rx="2"></rect><line x1="8" y1="6" x2="16" y2="6"></line><line x1="16" y1="14" x2="16" y2="14"></line><line x1="8" y1="14" x2="8" y2="14"></line><line x1="12" y1="14" x2="12" y2="14"></line><line x1="8" y1="10" x2="8" y2="10"></line><line x1="12" y1="10" x2="12" y2="10"></line><line x1="16" y1="10" x2="16" y2="10"></line><line x1="12" y1="18" x2="12" y2="18"></line><line x1="8" y1="18" x2="8" y2="18"></line><line x1="16" y1="18" x2="16" y2="18"></line>',
...
def generate_icons():
    ...
    for name, path_data in ICONS.items():
        svg_content = SVG_TEMPLATE.format(color=ICON_COLOR, content=path_data)
